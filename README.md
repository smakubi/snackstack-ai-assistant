...
<p align="center">
  <img src="snackstack_architecture.svg" alt="SnackStack Architecture" width="680"/>
</p>
...
| **Conditional edges** — agent → tools node loop or → synthesizer | `graph.py`, `menu_agent.py`, `order_agent.py` |
